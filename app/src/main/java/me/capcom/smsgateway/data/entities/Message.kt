...
data class Message constructor(
    ...
    constructor(
        ...
        type = when (content) {
            ...
            is MessageContent.Multimedia -> MessageType.Mms
        },
        createdAt = createdAt,
    )
    ...
    val mmsContent: MessageContent.Multimedia?
        get() = when (type) {
            MessageType.Mms -> gson.fromJson(content, MessageContent.Multimedia::class.java)
            else -> null
        }
